...
public class MapGenerator : MonoBehaviour
{
    ...
    private IEnumerator SpawnEnemiesAfterNavMesh()
    {
        ...
        enemySpawner.SpawnEnemies(mapData, grassTile, width, height);
    }
    ...
    private void SpawnItems()
    {
        ...
        {
            Vector3Int itemCell = FindSafeSpawnPoint();
            Vector3 itemPos = groundTilemap.CellToWorld(itemCell) + new Vector3(0.5f, 0.5f, 0);
